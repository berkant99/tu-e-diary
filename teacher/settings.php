                        ...
                        <div class="wrapper" style="box-shadow: none; background: none;">
                            ...
                            <?php if ($_SESSION["img"] != "default.jpg") : ?>
                                <div class="object-center" style="margin: 15px;">
                                    <div>
                                        <button id="delete-img-btn" type="button">
                                            <div class="hr-group"><i class="fa-solid fa-xmark" style="margin-right: 10px;"></i>Премахване на снимката</div>
                                        </button>
                                    </div>
                                </div>
                            <?php endif ?>
                            <form id="teacher-settings-form" action="#" method="POST" enctype="multipart/form-data" autocomplete="off" style="margin: 0;">
...
<script src="../teacher/assets/js/settings.js?v=<?php echo time(); ?>" type="module"></script>
